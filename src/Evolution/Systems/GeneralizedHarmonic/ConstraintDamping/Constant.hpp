...
//  * `Width` \f$w\f$, and `Center`\f$x_0\f$. The function takes input
//  coordinates
...
class Constant : public DampingFunction<VolumeDim, Fr> {
 public:
  ...
  static constexpr Options::String help = {
      "Computes a constant about an arbitrary coordinate "};
  ...
  void operator()(const gsl::not_null<Scalar<double>*> value_at_x, double time,
