...
def check_finite_difference_rank0(input_vector, perturbed_input_vectors,
                                  perturbation):
    ...
    derivative_tensor = []
    for i in range(len(perturbed_input_vectors)):
        derivative_tensor_indexed_value = (perturbed_input_vectors[i] -
                                           input_vector[0]) / perturbation[i]
...
def check_finite_difference_rank2(input_matrix, perturbed_input_matrix,
                                  perturbation):
    '''
    #parameters:
